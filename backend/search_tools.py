...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        formatted = []
        sources = []  # Track sources for the UI (now as objects with title and url)
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Track source for the UI with title and url
            ...
            sources.append({
                "title": source_title,
                "url": lesson_link  # may be None if no link exists
            })
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get a course outline including course title, course link, and complete lesson list with lesson numbers and titles. Use this for questions about course structure, syllabus, what lessons are covered, or course overview.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
